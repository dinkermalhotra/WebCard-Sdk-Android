...
public class ActivityIntroScreenBindingImpl extends ActivityIntroScreenBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvAName2, 4);
        sViewsWithIds.put(R.id.linInfo, 5);
        sViewsWithIds.put(R.id.btnStart, 6);
    }
    // views
    @NonNull
    ...
    public ActivityIntroScreenBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ActivityIntroScreenBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.abisyscorp.ivalt.custom.NormalButton) bindings[6]
